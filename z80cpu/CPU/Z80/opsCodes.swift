...
class z80InstructionSet {
    ...
    static let shared = z80InstructionSet()
    
    private init() {
        initOpsCodeTables()
    }

    private func initOpsCodeTables() {
        for i in 0...255 {
            let code = UInt8(i)
    ...
    private var z80OpsCodeTable :[opCode] = [
        ...
        opCode("LD (HL), r[z]", 0b11111000, 0b01110000, 1, [], ldHLr),
        ...
        opCode("ADC A, n", 0xFF, 0xCE, 2, [mrNpc(f: {cpu in cpu.adcA(cpu.fetched.n)})], {cpu in ()}),
        opCode("SBC A, n", 0xFF, 0xDE, 2, [mrNpc(f: {cpu in cpu.sbcA(cpu.fetched.n)})], {cpu in ()}),
        ...
        opCode("_CB", 0xFF, 0xCB, 1, [], {cpu in cpu.decodeCB()}, dis_invalid),
        opCode("_DD", 0xFF, 0xDD, 1, [], {cpu in cpu.decodeDD()}, dis_invalid),
        opCode("_ED", 0xFF, 0xED, 1, [], {cpu in cpu.decodeED()}, dis_invalid),
        opCode("_FD", 0xFF, 0xFD, 1, [], {cpu in cpu.decodeFD()}, dis_invalid),
    ]
    
    private var z80OpsCodeTableCB :[opCode] = [
        opCode("RLC r[z]", 0b11111000, 0b00000000, 1, [], cbR),
        opCode("RLC (HL)", 0xFF, 0x06, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        opCode("RRC r[z]", 0b11111000, 0b00001000, 1, [], cbR),
        opCode("RRC (HL)", 0xFF, 0x0e, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        
        opCode("RL r[z]", 0b11111000, 0b00010000, 1, [], cbR),
        opCode("RL (HL)", 0xFF, 0x16, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        opCode("RR r[z]", 0b11111000, 0b00011000, 1, [], cbR),
        opCode("RR (HL)", 0xFF, 0x1e, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        
        opCode("SLA r[z]", 0b11111000, 0b00100000, 1, [], cbR),
        opCode("SLA (HL)", 0xFF, 0x26, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        opCode("SRA r[z]", 0b11111000, 0b00101000, 1, [], cbR),
        opCode("SRA (HL)", 0xFF, 0x2e, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        
        opCode("SLL r[z]", 0b11111000, 0b00110000, 1, [], cbR),
        opCode("SLL (HL)", 0xFF, 0x36, 1, [Exec(l: 1, f: cbHL)], {cpu in ()}),
        opCode("SRL r[z]", 0b11111000, 0b00111000, 1, [], cbR),
    ...
    private var z80OpsCodeTableDD :[opCode] = [
        opCode("LD r[y], r[z]", 0b11000000, 0b01000000, 1, [], ldRr),
        ...
        opCode("LD r[z], (IX+d)", 0b11000111, 0b01000110, 2, [mrNpc(f:{cpu in ()}), Exec(l: 5, f: ldRixyD)], {cpu in ()}),
        opCode("LD (IX+d), r[z]", 0b11111000, 0b01110000, 2, [mrNpc(f:{cpu in ()}), Exec(l: 5, f: ldIXYdR)], {cpu in ()}),
        ...
        opCode("_CB", 0xFF, 0xCB, 2, [mrNpc(f: {cpu in cpu.decodeDDCB()})], {cpu in ()}),
    ...
    private var z80OpsCodeTableFD :[opCode] = [
        opCode("LD r[y], r[z]", 0b11000000, 0b01000000, 1, [], ldRr),
        ...
        opCode("_CB", 0xFF, 0xCB, 2, [mrNpc(f: {cpu in cpu.decodeFDCB()})], {cpu in ()}),
    ...
    private var z80OpsCodeTableDDCB :[opCode] = [
    ...
    private var z80OpsCodeTableFDCB :[opCode] = [
    ...
    private var z80OpsCodeTableED :[opCode] = [
